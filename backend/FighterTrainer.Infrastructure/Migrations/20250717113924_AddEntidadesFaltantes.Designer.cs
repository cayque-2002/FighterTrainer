...
namespace FighterTrainer.Infrastructure.Migrations
{
    ...
    [Migration("20250717113924_AddEntidadesFaltantes")]
    partial class AddEntidadesFaltantes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FighterTrainer.Domain.Entities.FichaTreino", b =>
                {
                    ...
                    b.Property<long>("UsuarioModalidadeModalidadeId")
                        .HasColumnType("bigint");

                    b.Property<long>("UsuarioModalidadeUsuarioId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UsuarioModalidadeUsuarioId", "UsuarioModalidadeModalidadeId");
            ...
            modelBuilder.Entity("FighterTrainer.Domain.Entities.UsuarioModalidade", b =>
                {
                    ...
                    b.HasKey("UsuarioId", "ModalidadeId");
            ...
            modelBuilder.Entity("FighterTrainer.Domain.Entities.FichaTreino", b =>
                {
                    ...
                    b.HasOne("FighterTrainer.Domain.Entities.UsuarioModalidade", "UsuarioModalidade")
                        .WithMany()
                        .HasForeignKey("UsuarioModalidadeUsuarioId", "UsuarioModalidadeModalidadeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
