...
public class PresencaController : ControllerBase
{
    ...
    public PresencaController(AppDbContext context, ITokenService tokenService, FichaTreinoService fichaTreinoService, IFichaTreinoService iFichaTreinoService)
    {
        _context = context;
